...
namespace DomainDrivenDesign.CrossCutting.Identity.Configuration
{
    ...
    {
        private static async Task<bool> VerifySecurityStampAsync(ApplicationUserManager manager, IdentityUser user, CookieValidateIdentityContext context)
        {
        ...
        private static Task<bool> VerifyClientIdAsync(ApplicationUserManager manager, IdentityUser user, CookieValidateIdentityContext context)
        {
        ...
        public static Func<CookieValidateIdentityContext, Task> OnValidateIdentity(TimeSpan validateInterval, Func<ApplicationUserManager, IdentityUser, Task<ClaimsIdentity>> regenerateIdentity)
        {
